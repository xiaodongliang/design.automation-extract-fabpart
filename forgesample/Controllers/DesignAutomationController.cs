...
namespace forgeSample.Controllers
{
    ...
    public class DesignAutomationController : ControllerBase
    {
            ...
            if (!activities.Data.Contains(qualifiedActivityId))
            {
                ...
                Activity activitySpec = new Activity()
                {
                    ...
                    Parameters = new Dictionary<string, Parameter>()
                    {
                        ...
                        { "outputFile", new Parameter() { Description = "output file", LocalName = "dump_mep_data.csv", Ondemand = false, Required = true, Verb = Verb.Put, Zip = false } }
                    },
        ...
        public async Task<IActionResult> StartWorkitem([FromForm]StartWorkitemInput input)
        {
            ...
            string outputFileNameOSS = string.Format("{0}_output_{1}", DateTime.Now.ToString("yyyyMMddhhmmss"), Path.GetFileName(input.inputFile.FileName)+".csv"); // avoid overriding
